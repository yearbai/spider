...
(function ($, window, document, undefined) {
    ...
    BaseFile.prototype.default = {
        ...
        fileinput: {
            language: 'zh',
            uploadUrl: ctxPath + "/file/uploadMultipleFile",
            deleteUrl:ctxPath+"/file/delete",
            uploadAsync:false,
    ...
    BaseFile.prototype.getFileIconSettings = function () {
        var self = this;
        ajaxPost(ctxPath + "/file/icons", null, function (icons) {
    ...
    BaseFile.prototype.downloadHandler=function(fileobj){
        ...
        objs.on("click",function(){
           //点击下载
            window.location.href=ctxPath+"/file/download/"+$(this).data("key");
        });
    }
    /**
    ...
    BaseFile.prototype.getFileResult=function(fileIds){
        var ret=null;
        ajaxPost(ctxPath+"/file/getFiles",{fileIds:fileIds},function(result){
            ret=result;
        });
        return ret;
    };
