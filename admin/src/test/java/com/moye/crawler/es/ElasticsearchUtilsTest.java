...
/**
    ...
    @Test
    public void delete() {
        ElasticsearchUtils.deleteIndex("commons");
    }
...
/**
    ...
    public void searchDataByIdTest() {
        Map<String, Object> map = ElasticsearchUtils.searchDataById("commons", "webpage", "74f6e3b021b8c3c5774efa55d1ee7bd0", null);
...
/**
    ...
    public void searchDataPage() {
        ...
        EsPage esPage = ElasticsearchUtils.searchDataPage("commons", "webpage", 0, 10,
                0, 0, "title,domain,publishTime", "publishTime", false, "title",
                "");
    ...
    public void testPage(){
        Page<Webpage> page = new Page<>();
        page.setCurrent(0);
        page.setSize(10);
        Map<String,String> stringMap = new HashMap<>();
        stringMap.put("title","我知道你为什么活得那么累");
        Page<Map<String, Object>> page1 = taskService.findSpiderDataPage(page,stringMap);
        System.out.println(JSONObject.toJSONString(page1));
    }

    @Test
    public void testList(){
        List<Webpage>  list =  ElasticsearchUtils.moreLikeThis("a18b8838b4aa5a86ae8f7597add0e2e9",15,1);
    ...
    public void testDeleteByParam(){
        ...
        param.put("spiderInfoId", "1");
        ElasticsearchUtils.deleteByTerm("commons", "webpage", param);
    }
