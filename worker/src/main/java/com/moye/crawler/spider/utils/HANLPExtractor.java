package com.moye.crawler.spider.utils;
...
public class HANLPExtractor  {
     ...
     */
    public static Map<String, Set<String>> extractNamedEntity(String content) {
    ...
    public static void main(String[] args) {
        List<String> list = HANLPExtractor.extractKeywords("爱的发生发生的发生发生FDA手动阀手动阀手动阀手动阀");
